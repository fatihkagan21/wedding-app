# Anı köşesi yükleme kurulumu

Bu özellik `POST /photos/upload` üzerinden gelen fotoğraf, video ve ses dosyalarını kişisel Google Drive hesabındaki özel bir klasöre yükler. Veritabanına kayıt atmaz, istemciye Drive dosya kimliği veya bağlantısı dönmez.
...
- [ ] MP3, M4A, AAC, WAV, OGG, Opus, 3GP, AMR veya FLAC ses dosyası yüklenebiliyor.
